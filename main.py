#################################################
# Code taken from: https://github.com/DKarandikar/Flocking/blob/master/Flocking/Flocking.py
# On 04/08/2023
# License: https://github.com/DKarandikar/Flocking/blob/master/LICENSE
# CHANGELOG
# - Flocking class constructor modified
# - World class constructor. width and height added
# - Boids rules set. ATTRACT REPULSE ALIGN
# - Obstacles turn to global. The circular obstacle size set
# - Checkbox for obstacle created with default value checked
# - Obstacle visibility turn to none
# - Speed value set to a global variable and a range button added on the ui to control the speed.
# - Update method in Flocking class modified (self.canvas.delete("all") removed)
# - Draw_boids method in Flocking class modified (a list of colours added, draw shape modified, and a logic for changing colour value).
...
class Flocking(tk.Tk):
    ...
    def draw_boids(self):
        ...
        colours = ['#FF0000', '#FF7F00', '#FFA500', '#FFFF00', '#ADFF2F', '#32CD32', '#00FF7F', '#00FFFF', '#87CEEB',
                   '#1E90FF', '#0000FF', '#4B0082', '#8B00FF', '#FF00FF', '#FF1493', '#FF69B4', '#CD5C5C', '#A0522D',
                   '#F0E68C', '#BDB76B', '#556B2F', '#808000', '#8FBC8F', '#2E8B57', '#00FF00', '#98FB98', '#ADD8E6',
                   '#F08080', '#FFA07A', '#FFDAB9', '#FFDEAD', '#F5DEB3', '#FAF0E6', '#FFE4B5', '#EEE8AA', '#D2B48C',
                   '#F4A460', '#B8860B', '#FF8C00', '#FFA500', '#FFD700', '#FFFF00', '#9ACD32', '#7CFC00', '#00FF00',
                   '#00FA9A', '#00CED1', '#87CEEB', '#1E90FF', '#8A2BE2']
        ...
        for boid in self.world.boids:
            ...
            self.canvas.create_polygon((tip_x, tip_y,
                                        int(boid.pos_x - (4 * boid.vel_y)),
                                        int(boid.pos_y + (4 * boid.vel_x)),
                                        int(boid.pos_x + (4 * boid.vel_y)),
                                        int(boid.pos_y - (4 * boid.vel_x))),
